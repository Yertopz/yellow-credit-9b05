...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/yellow-credit-9b05)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/yellow-credit-9b05
```

A live public deployment of this template is available at [https://yellow-credit-9b05.templates.workers.dev](https://yellow-credit-9b05.templates.workers.dev)
